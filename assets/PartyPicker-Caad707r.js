import{n as e,r as t}from"./rolldown-runtime-hePW80VL.js";import{t as n}from"./react-CwJFpaho.js";import{t as r}from"./supabase-XhiQfxjX.js";import{b as i}from"./index-D8FPL4u1.js";import{a,r as o}from"./utils-CfsB92wt.js";import{t as s}from"./check-CmWUQ7w7.js";import{t as c}from"./chevron-down-ReUDoNBx.js";import{t as l}from"./plus-CqRdagZ5.js";import{t as u}from"./search-M8UP9eTU.js";import{t as d}from"./truck-CU5t2ypP.js";import{t as f}from"./user-CgVubRYc.js";import{n as p}from"./transliterate-D-5hWP-j.js";var m=e({buildInvoicePrintHtml:()=>y,buildInvoiceQrText:()=>v,openPrintWindow:()=>b}),h={cash:`نقدي`,card:`شبكة`,bank_transfer:`تحويل بنكي`,online:`أونلاين`,apple_pay:`Apple Pay`,google_pay:`Google Pay`,wallet:`محفظة رقمية`,credit:`آجل`,check:`شيك`,mixed:`مقسّم (كاش + شبكة)`},g={paid:`مدفوعة`,partial:`جزئية`,unpaid:`غير مدفوعة`};function _(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function v(e){let t=[];return t.push(`${e.kind===`sale`?`فاتورة بيع`:`فاتورة شراء`} رقم: ${e.number||`—`}`),t.push(`التاريخ: ${e.date||`—`} | ${e.kind===`sale`?`العميل`:`المورد`}: ${e.party||`—`} | الفرع: ${e.branch||`—`}`),t.push(`الدفع: ${e.payment||`—`} | الحالة: ${e.status||`—`}`),t.push(`الأصناف:`),(e.items||[]).forEach((e,n)=>{let r=e.name||e.description||`—`,i=Number(e.qty)||0,a=Number(e.unit_price??e.price)||0,o=Number(e.total)||i*a;t.push(`${n+1}) ${r} × ${i} @ ${a} = ${o}`)}),t.push(`الإجمالي: ${Number(e.total)||0} | المدفوع: ${Number(e.paid)||0} | المتبقي: ${Number(e.remaining)||0} ${e.currency||``}`),t.join(`
