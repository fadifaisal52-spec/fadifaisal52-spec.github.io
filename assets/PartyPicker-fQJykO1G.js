...
<div class="sub">${[b,t.address,t.phone?`هاتف: ${t.phone}`:``,t.vat_no?`سجل/ضريبي: ${t.vat_no}`:``].filter(Boolean).join(` • `)||a(e.date)}</div>
</div>
...
<tr><td class="lbl">رقم الفاتورة</td><td class="val">${_(e.number||`—`)}</td><td class="lbl">التاريخ${e.due_date?` / الاستحقاق`:``}</td><td class="val" colspan="3">${a(e.date)}${e.due_date?` / ${a(e.due_date)}`:``}</td></tr>
...
<tr><td class="lbl">الدفع</td><td class="val">${_(h[e.payment_method||``]||e.payment_method||`—`)}${m||v?` (كاش: ${o(m,s)} • شبكة: ${o(v,s)})`:``}</td><td class="lbl">الحالة</td><td class="val" colspan="3"><span class="status-pill">${g[e.status||``]||e.status||`—`}</span></td></tr>
