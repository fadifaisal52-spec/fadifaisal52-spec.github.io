...
${b}
<table><thead><tr><th>#</th>${p}</tr></thead><tbody>${h||`<tr><td colspan="${t.length+1}" style="text-align:center;color:#94a3b8;padding:24px">لا توجد بيانات</td></tr>`}</tbody>${v?`<tfoot>${_}${v}</tfoot>`:``}</table>
${x}
...
</body></html>`}function m({title:e,columns:t,rows:n,companyName:c,vatNo:d,size:f=`md`,subtitle:m,extraFields:h,summary:g,dateFilterKey:_}){let[v,y]=(0,l.useState)(!1),[b,x]=(0,l.useState)(``),[S,C]=(0,l.useState)(``),w=_?n.filter(e=>{let t=e[_];if(!t)return!0;let n=typeof t==`string`?t.slice(0,10):``;return!n||!(b&&n<b||S&&n>S)}):n;return(0,u.jsxs)(u.Fragment,{children:[(0,u.jsxs)(`button`,{onClick:()=>y(!0),className:f===`sm`?`btn-ghost px-2.5 py-1.5 text-xs`:`btn-ghost`,"aria-label":`طباعة`,children:[(0,u.jsx)(o,{className:f===`sm`?`w-3.5 h-3.5`:`w-4 h-4`}),f!==`sm`&&(0,u.jsx)(`span`,{children:`طباعة`})]}),v&&(0,u.jsx)(`div`,{className:`fixed inset-0 z-50 flex items-center justify-center bg-black/40 animate-fade-in p-4`,onClick:()=>y(!1),children:(0,u.jsxs)(`div`,{className:`card w-full max-w-sm animate-scale-in`,onClick:e=>e.stopPropagation(),children:[(0,u.jsxs)(`div`,{className:`flex items-center justify-between px-5 py-4 border-b border-slate-100 dark:border-slate-800`,children:[(0,u.jsxs)(`h3`,{className:`font-bold text-primary-900 dark:text-slate-50 flex items-center gap-2`,style:{fontFamily:`'Plus Jakarta Sans', sans-serif`},children:[(0,u.jsx)(a,{className:`w-4 h-4 text-accent-600`}),` طباعة: `,e]}),(0,u.jsx)(`button`,{onClick:()=>y(!1),className:`w-8 h-8 grid place-items-center rounded-lg text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800`,children:(0,u.jsx)(s,{className:`w-4 h-4`})})]}),(0,u.jsxs)(`div`,{className:`p-5 space-y-4`,children:[(0,u.jsxs)(`div`,{children:[(0,u.jsxs)(`label`,{className:`label flex items-center gap-1.5`,children:[(0,u.jsx)(r,{className:`w-3.5 h-3.5`}),` نطاق التاريخ (اختياري)`]}),(0,u.jsxs)(`div`,{className:`flex gap-2`,children:[(0,u.jsx)(`input`,{type:`date`,value:b,onChange:e=>x(e.target.value),className:`input flex-1 text-sm`}),(0,u.jsx)(`input`,{type:`date`,value:S,onChange:e=>C(e.target.value),className:`input flex-1 text-sm`})]}),(0,u.jsx)(`p`,{className:`text-xs text-slate-400 mt-1.5`,children:`اتركهما فارغين لطباعة الكل`})]}),(0,u.jsxs)(`div`,{className:`text-sm text-slate-500 bg-slate-50 dark:bg-slate-800 rounded-xl p-3 space-y-1`,children:[(0,u.jsxs)(`p`,{children:[`عدد السجلات: `,(0,u.jsx)(`strong`,{className:`text-primary-900 dark:text-slate-50`,children:w.length})]}),(0,u.jsxs)(`p`,{children:[`عدد الأعمدة: `,(0,u.jsx)(`strong`,{className:`text-primary-900 dark:text-slate-50`,children:t.length})]}),h&&h.length>0&&(0,u.jsxs)(`p`,{children:[`حقول إضافية: `,(0,u.jsx)(`strong`,{className:`text-primary-900 dark:text-slate-50`,children:h.length})]})]}),(0,u.jsxs)(`div`,{className:`flex gap-2`,children:[(0,u.jsx)(`button`,{onClick:()=>y(!1),className:`btn-ghost flex-1`,children:`إلغاء`}),(0,u.jsxs)(`button`,{onClick:()=>{let n=p(e,t,w,{companyName:c,vatNo:d,subtitle:m,dateRange:b||S?{from:b||`—`,to:S||`—`}:void 0,extraFields:h,summary:g}),r=document.createElement(`iframe`);r.style.cssText=`position:fixed;right:0;bottom:0;width:0;height:0;border:0;visibility:hidden;`,r.onload=()=>{let e=r.contentWindow;if(!e){r.parentNode&&document.body.removeChild(r);return}try{e.focus(),e.print()}catch(e){console.error(`Print failed:`,e)}setTimeout(()=>{r.parentNode&&document.body.removeChild(r)},2e3)},r.srcdoc=n,document.body.appendChild(r),y(!1)},className:`btn-primary flex-1`,children:[(0,u.jsx)(o,{className:`w-4 h-4`}),` طباعة`]}),(0,u.jsxs)(`button`,{onClick:()=>{let n=p(e,t,w,{companyName:c,vatNo:d,subtitle:m,dateRange:b||S?{from:b||`—`,to:S||`—`}:void 0,extraFields:h,summary:g}),r=window.open(``,`_blank`);if(!r){alert(`يرجى السماح بالنوافذ المنبثقة لتصدير PDF`);return}r.document.write(n),r.document.close(),setTimeout(()=>{r.focus(),r.print()},500),y(!1)},className:`btn-primary flex-1`,children:[(0,u.jsx)(i,{className:`w-4 h-4`}),` PDF`]})]})]})]})})]})}export{m as t};