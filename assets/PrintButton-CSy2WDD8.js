import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./react-Biaal4sZ.js";import{t as n}from"./calendar-Dmu3vixj.js";import{t as r}from"./file-down-MrfyYJYS.js";import{t as i}from"./file-text-D1k8ROVD.js";import{t as a}from"./printer-CDm5_t0y.js";import{A as o,b as s}from"./index-DPFrQ8Ae.js";import{c}from"./utils-Bs8Fug52.js";import{t as l}from"./date-picker-BT5qU17l.js";var u=e(t(),1),d=o(),f=e=>e!=null&&e!==``&&!isNaN(Number(e));function p(e){let t=Number(e);return isNaN(t)?String(e??``):t.toLocaleString(`en-US`,{minimumFractionDigits:2,maximumFractionDigits:2})}function m(e,t,n,r){let{vatNo:i,subtitle:a,dateRange:o,extraFields:s,summary:l}=r,u=t.map(e=>`<th>${c(e.label)}</th>`).join(``),d=t.map(e=>n.some(t=>f(t[e.key]))),m=n.map((e,n)=>{let r=t.map((t,n)=>{let r=e[t.key]??``;r??=``;let i=d[n]?p(r):String(r);return`<td${d[n]?` style="text-align:left;font-variant-numeric:tabular-nums"`:``}>${i}</td>`}).join(``),i=``;if(e.notes&&(i+=`<div class="row-notes">ملاحظات: ${c(e.notes)}</div>`),e.address&&(i+=`<div class="row-notes">العنوان: ${c(e.address)}</div>`),e.items_detail&&(i+=`<div class="row-notes">البيان/الأصناف: ${c(e.items_detail)}</div>`),e.description&&!t.find(e=>e.key===`description`)&&(i+=`<div class="row-notes">الوصف: ${c(e.description)}</div>`),e.custom_values&&typeof e.custom_values==`object`){let t=e.custom_values,n=Object.entries(t).filter(([,e])=>e!==``&&e!=null);n.length&&(i+=`<div class="row-custom">`+n.map(([e,t])=>`<span>${e}: ${t}</span>`).join(` • `)+`</div>`)}return`<tr class="${n%2==0?``:`alt`}"><td style="text-align:center;color:#94a3b8">${n+1}</td>${r}</tr>${i?`<tr class="extra-row"><td colspan="${t.length+1}">${i}</td></tr>`:``}`}).join(``),h=t.map((e,t)=>d[t]?n.reduce((t,n)=>t+(f(n[e.key])?Number(n[e.key]):0),0):null),g=h.some(e=>e!==null)?`<tr class="sum-row"><td style="text-align:center;font-weight:700">Σ</td>${t.map((e,t)=>h[t]===null?`<td></td>`:`<td style="text-align:left;font-variant-numeric:tabular-nums;font-weight:700">${p(h[t])}</td>`).join(``)}</tr>`:``,_=n.length>0?`<tr class="count-row"><td colspan="${t.length+1}">عدد السجلات: ${n.length}</td></tr>`:``,v=o?`<div class="meta-item"><span class="meta-label">الفترة:</span> <span class="meta-value">${o.from} — ${o.to}</span></div>`:``,y=s&&s.length?`<div class="extra-fields">${s.map(e=>`<div class="ef-item"><span class="ef-label">${c(e.label)}:</span> <span class="ef-value">${c(e.value)}</span></div>`).join(``)}</div>`:``,b=l&&l.length?`<div class="summary-section"><div class="summary-title">الإجماليات</div><div class="summary-grid">${l.map(e=>`<div class="summary-item"><span class="summary-label">${c(e.label)}</span><span class="summary-value">${c(e.value)}</span></div>`).join(``)}</div></div>`:``,x=new Date,S=x.toLocaleDateString(`en-GB`),C=x.toLocaleTimeString(`en-GB`,{hour:`2-digit`,minute:`2-digit`});return`<!DOCTYPE html><html dir="rtl"><head><meta charset="utf-8"><title>${e}</title>
<style>
...
</body></html>`}function h({title:e,columns:t,rows:o,companyName:c,vatNo:f,size:p=`md`,subtitle:h,extraFields:g,summary:_,dateFilterKey:v}){let[y,b]=(0,u.useState)(!1),[x,S]=(0,u.useState)(``),[C,w]=(0,u.useState)(``),T=v?o.filter(e=>{let t=e[v];if(!t)return!0;let n=typeof t==`string`?t.slice(0,10):``;return!n||!(x&&n<x||C&&n>C)}):o;return(0,d.jsxs)(d.Fragment,{children:[(0,d.jsxs)(`button`,{onClick:()=>b(!0),className:p===`sm`?`btn-ghost px-2.5 py-1.5 text-xs`:`btn-ghost`,"aria-label":`طباعة`,children:[(0,d.jsx)(a,{className:p===`sm`?`w-3.5 h-3.5`:`w-4 h-4`}),p!==`sm`&&(0,d.jsx)(`span`,{children:`طباعة`})]}),y&&(0,d.jsx)(`div`,{className:`fixed inset-0 z-50 flex items-center justify-center bg-black/40 animate-fade-in p-4`,onClick:()=>b(!1),children:(0,d.jsxs)(`div`,{className:`card w-full max-w-sm animate-scale-in`,onClick:e=>e.stopPropagation(),children:[(0,d.jsxs)(`div`,{className:`flex items-center justify-between px-5 py-4 border-b border-slate-100 dark:border-slate-800`,children:[(0,d.jsxs)(`h3`,{className:`font-bold text-primary-900 dark:text-slate-50 flex items-center gap-2`,style:{fontFamily:`'Plus Jakarta Sans', sans-serif`},children:[(0,d.jsx)(i,{className:`w-4 h-4 text-accent-600`}),` طباعة: `,e]}),(0,d.jsx)(`button`,{onClick:()=>b(!1),className:`w-8 h-8 grid place-items-center rounded-lg text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800`,children:(0,d.jsx)(s,{className:`w-4 h-4`})})]}),(0,d.jsxs)(`div`,{className:`p-5 space-y-4`,children:[(0,d.jsxs)(`div`,{children:[(0,d.jsxs)(`label`,{className:`label flex items-center gap-1.5`,children:[(0,d.jsx)(n,{className:`w-3.5 h-3.5`}),` نطاق التاريخ (اختياري)`]}),(0,d.jsxs)(`div`,{className:`flex gap-2`,children:[(0,d.jsx)(l,{value:x,onChange:e=>S(e)}),(0,d.jsx)(l,{value:C,onChange:e=>w(e)})]}),(0,d.jsx)(`p`,{className:`text-xs text-slate-400 mt-1.5`,children:`اتركهما فارغين لطباعة الكل`})]}),(0,d.jsxs)(`div`,{className:`text-sm text-slate-500 bg-slate-50 dark:bg-slate-800 rounded-xl p-3 space-y-1`,children:[(0,d.jsxs)(`p`,{children:[`عدد السجلات: `,(0,d.jsx)(`strong`,{className:`text-primary-900 dark:text-slate-50`,children:T.length})]}),(0,d.jsxs)(`p`,{children:[`عدد الأعمدة: `,(0,d.jsx)(`strong`,{className:`text-primary-900 dark:text-slate-50`,children:t.length})]}),g&&g.length>0&&(0,d.jsxs)(`p`,{children:[`حقول إضافية: `,(0,d.jsx)(`strong`,{className:`text-primary-900 dark:text-slate-50`,children:g.length})]})]}),(0,d.jsxs)(`div`,{className:`flex gap-2`,children:[(0,d.jsx)(`button`,{onClick:()=>b(!1),className:`btn-ghost flex-1`,children:`إلغاء`}),(0,d.jsxs)(`button`,{onClick:()=>{let n=m(e,t,T,{companyName:c,vatNo:f,subtitle:h,dateRange:x||C?{from:x||`—`,to:C||`—`}:void 0,extraFields:g,summary:_}),r=document.createElement(`iframe`);r.style.cssText=`position:fixed;right:0;bottom:0;width:0;height:0;border:0;visibility:hidden;`,r.onload=()=>{let e=r.contentWindow;if(!e){r.parentNode&&document.body.removeChild(r);return}try{e.focus(),e.print()}catch(e){console.error(`Print failed:`,e)}setTimeout(()=>{r.parentNode&&document.body.removeChild(r)},2e3)},r.srcdoc=n,document.body.appendChild(r),b(!1)},className:`btn-primary flex-1`,children:[(0,d.jsx)(a,{className:`w-4 h-4`}),` طباعة`]}),(0,d.jsxs)(`button`,{onClick:()=>{let n=m(e,t,T,{companyName:c,vatNo:f,subtitle:h,dateRange:x||C?{from:x||`—`,to:C||`—`}:void 0,extraFields:g,summary:_}),r=window.open(``,`_blank`);if(!r){alert(`يرجى السماح بالنوافذ المنبثقة لتصدير PDF`);return}r.document.write(n),r.document.close(),setTimeout(()=>{r.focus(),r.print()},500),b(!1)},className:`btn-primary flex-1`,children:[(0,d.jsx)(r,{className:`w-4 h-4`}),` PDF`]})]})]})]})})]})}export{h as t};