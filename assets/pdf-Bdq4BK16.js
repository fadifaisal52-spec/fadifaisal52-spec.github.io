...
<h2>إيصال</h2>
${e.cashier_name?`<div class="center">${e.cashier_name}</div>`:``}
...
${e.customer_name?`<div class="center">العميل: ${e.customer_name}${e.customer_phone?` - `+e.customer_phone:``}</div>`:``}
${e.customer_address?`<div class="center">العنوان: ${e.customer_address}</div>`:``}
${e.delivery_fee?`<div class="center">رسوم التوصيل: ${Number(e.delivery_fee).toFixed(2)} ${i}</div>`:``}
