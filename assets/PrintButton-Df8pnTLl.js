...
</body></html>`}function h({title:e,columns:t,rows:n,companyName:r,vatNo:c,size:f=`md`,subtitle:p,extraFields:h,summary:g,dateFilterKey:_}){let[v,y]=(0,u.useState)(!1),[b,x]=(0,u.useState)(``),[S,C]=(0,u.useState)(``),w=_?n.filter(e=>{let t=e[_];if(!t)return!0;let n=typeof t==`string`?t.slice(0,10):``;return!n||!(b&&n<b||S&&n>S)}):n;return(0,d.jsxs)(d.Fragment,{children:[(0,d.jsxs)(`button`,{onClick:()=>y(!0),className:f===`sm`?`btn-ghost px-2.5 py-1.5 text-xs`:`btn-ghost`,"aria-label":`طباعة`,children:[(0,d.jsx)(o,{className:f===`sm`?`w-3.5 h-3.5`:`w-4 h-4`}),f!==`sm`&&(0,d.jsx)(`span`,{children:`طباعة`})]}),v&&(0,d.jsx)(`div`,{className:`fixed inset-0 z-50 flex items-center justify-center bg-black/40 animate-fade-in p-4`,onClick:()=>y(!1),children:(0,d.jsxs)(`div`,{className:`card w-full max-w-sm animate-scale-in`,onClick:e=>e.stopPropagation(),children:[(0,d.jsxs)(`div`,{className:`flex items-center justify-between px-5 py-4 border-b border-slate-100 dark:border-slate-800`,children:[(0,d.jsxs)(`h3`,{className:`font-bold text-primary-900 dark:text-slate-50 flex items-center gap-2`,style:{fontFamily:`'Plus Jakarta Sans', sans-serif`},children:[(0,d.jsx)(a,{className:`w-4 h-4 text-accent-600`}),` طباعة: `,e]}),(0,d.jsx)(`button`,{onClick:()=>y(!1),className:`w-8 h-8 grid place-items-center rounded-lg text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800`,children:(0,d.jsx)(s,{className:`w-4 h-4`})})]}),(0,d.jsxs)(`div`,{className:`p-5 space-y-4`,children:[(0,d.jsxs)(`div`,{children:[(0,d.jsxs)(`label`,{className:`label flex items-center gap-1.5`,children:[(0,d.jsx)(i,{className:`w-3.5 h-3.5`}),` نطاق التاريخ (اختياري)`]}),(0,d.jsxs)(`div`,{className:`flex gap-2`,children:[(0,d.jsx)(`input`,{type:`date`,value:b,onChange:e=>x(e.target.value),className:`input flex-1 text-sm`}),(0,d.jsx)(`input`,{type:`date`,value:S,onChange:e=>C(e.target.value),className:`input flex-1 text-sm`})]}),(0,d.jsx)(`p`,{className:`text-xs text-slate-400 mt-1.5`,children:`اتركهما فارغين لطباعة الكل`})]}),(0,d.jsxs)(`div`,{className:`text-sm text-slate-500 bg-slate-50 dark:bg-slate-800 rounded-xl p-3 space-y-1`,children:[(0,d.jsxs)(`p`,{children:[`عدد السجلات: `,(0,d.jsx)(`strong`,{className:`text-primary-900 dark:text-slate-50`,children:w.length})]}),(0,d.jsxs)(`p`,{children:[`عدد الأعمدة: `,(0,d.jsx)(`strong`,{className:`text-primary-900 dark:text-slate-50`,children:t.length})]}),h&&h.length>0&&(0,d.jsxs)(`p`,{children:[`حقول إضافية: `,(0,d.jsx)(`strong`,{className:`text-primary-900 dark:text-slate-50`,children:h.length})]})]}),(0,d.jsxs)(`div`,{className:`flex gap-2`,children:[(0,d.jsx)(`button`,{onClick:()=>y(!1),className:`btn-ghost flex-1`,children:`إلغاء`}),(0,d.jsxs)(`button`,{onClick:()=>{let n=m(e,t,w,{companyName:r,vatNo:c,subtitle:p,dateRange:b||S?{from:b||`—`,to:S||`—`}:void 0,extraFields:h,summary:g}),i=document.createElement(`iframe`);i.style.cssText=`position:fixed;right:0;bottom:0;width:0;height:0;border:0;visibility:hidden;`,i.onload=()=>{let e=i.contentWindow;if(!e){i.parentNode&&document.body.removeChild(i);return}try{e.focus(),e.print()}catch(e){console.error(`Print failed:`,e)}setTimeout(()=>{i.parentNode&&document.body.removeChild(i)},2e3)},i.srcdoc=n,document.body.appendChild(i),y(!1)},className:`btn-primary flex-1`,children:[(0,d.jsx)(o,{className:`w-4 h-4`}),` طباعة`]}),(0,d.jsxs)(`button`,{onClick:()=>{let n=m(e,t,w,{companyName:r,vatNo:c,subtitle:p,dateRange:b||S?{from:b||`—`,to:S||`—`}:void 0,extraFields:h,summary:g}),i=window.open(``,`_blank`);if(!i){alert(`يرجى السماح بالنوافذ المنبثقة لتصدير PDF`);return}i.document.write(n),i.document.close(),setTimeout(()=>{i.focus(),i.print()},500),y(!1)},className:`btn-primary flex-1`,children:[(0,d.jsx)(l,{className:`w-4 h-4`}),` PDF`]})]})]})]})})]})}export{h as t};