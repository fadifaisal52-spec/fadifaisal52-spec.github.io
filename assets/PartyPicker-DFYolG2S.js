import{n as e,r as t}from"./rolldown-runtime-QTnfLwEv.js";import{t as n}from"./react-Biaal4sZ.js";import{t as r}from"./supabase-CczOb_er.js";import{D as i}from"./index-CO4pkIoS.js";import{i as a,o}from"./utils-Bs8Fug52.js";import{t as s}from"./check-C8MgLjkP.js";import{t as c}from"./chevron-down-DRjC2pIN.js";import{t as l}from"./plus-DmV4RmJ2.js";import{t as u}from"./search-gisWYDL1.js";import{t as d}from"./truck-v_Utro-Q.js";import{t as f}from"./user-bnoO63g4.js";import{n as p}from"./transliterate-D-5hWP-j.js";var m=e({buildInvoicePrintHtml:()=>y,buildInvoiceQrText:()=>v,openPrintWindow:()=>b}),h={cash:`نقدي`,card:`شبكة`,bank_transfer:`تحويل بنكي`,online:`أونلاين`,apple_pay:`Apple Pay`,google_pay:`Google Pay`,wallet:`محفظة رقمية`,credit:`آجل`,check:`شيك`,mixed:`مقسّم (كاش + شبكة)`},g={paid:`مدفوعة`,partial:`جزئية`,unpaid:`غير مدفوعة`};function _(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function v(e){let t=[];return t.push(`${e.kind===`sale`?`فاتورة بيع`:`فاتورة شراء`} رقم: ${e.number||`—`}`),t.push(`التاريخ: ${e.date||`—`} | ${e.kind===`sale`?`العميل`:`المورد`}: ${e.party||`—`} | الفرع: ${e.branch||`—`}`),t.push(`الدفع: ${e.payment||`—`} | الحالة: ${e.status||`—`}`),t.push(`الأصناف:`),(e.items||[]).forEach((e,n)=>{let r=e.name||e.description||`—`,i=Number(e.qty)||0,a=Number(e.unit_price??e.price)||0,o=Number(e.total)||i*a;t.push(`${n+1}) ${r} × ${i} @ ${a} = ${o}`)}),t.push(`الإجمالي: ${Number(e.total)||0} | المدفوع: ${Number(e.paid)||0} | المتبقي: ${Number(e.remaining)||0} ${e.currency||``}`),t.join(`
